...
export class PostCreateComponent implements OnInit{
  ...
  onImagePicked(event: Event) {
    ...
    this.form.get('image').updateValueAndValidity(); // angular informed value changed, re-avalute, store, and check validity
    const reader = new FileReader(); //convert image file to a 
    reader.onload = () => {
